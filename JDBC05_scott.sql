...
-- 사번 검색 
SELECT * FROM EMPVIEW WHERE EMP_ID = 1001
;

-- 이름 검색 
SELECT * FROM EMPVIEW WHERE EMP_NAME = '홍길동'
;

-- 부서 검색
SELECT * FROM EMPVIEW WHERE BUSEO_NAME = '기획부'
;

-- 직위 검색
SELECT * FROM EMPVIEW WHERE JIKWI_NAME = '부장'
;




--8. 직원 데이터 전체 조회 쿼리문(사번/이름/부서/직위/급여 내림차순 정렬) 
...
--> 한 줄 구성
SELECT * FROM EMPVIEW ORDER BY BUSEO_NAME
;
-- 직위 정렬
SELECT *
FROM EMPVIEW
...
--> 한 줄 구성
SELECT * FROM EMPVIEW ORDER BY JIKWI_NAME
...
--> 한 줄 구성
SELECT * FROM EMPVIEW ORDER BY PAY DESC
;
*/
...
-- 11. 직원 데이터 삭제 쿼리문 구성
DELETE  FROM TBL_EMP WHERE EMP_ID = 1063
;
