...
public class MemberProcess
{
	...
	// 직원 전체 출력 메소드 정의
	public void memberLists() throws SQLException
	{
		/*
		Scanner sc = new Scanner(System.in);
	   ...
	   for (MemberDTO dto : arrayList)
		{
		   System.out.printf("%6d     %5s    %14s     %14s   %6s    %16s      %5s   %5s  %10d %10d %10d"
		          , dto.getEmpId(), dto.get이름, 주민번호);
		}
		*/
		...
		try
		{
			...
			switch (menu)
			{
				case 1: key = "EMP_ID ASC"; break;
				case 2: key = "EMP_NAME ASC"; break;
				case 3: key = "BUSEO_NAME ASC"; break;
				case 4: key = "JIKWI_NAME ASC"; break;
				case 5: key = "PAY DESC"; break;
			}
	...
	public void memberUpdate()
	{
		...
		{
			// 수정 대상 입력 받기
			System.out.print("수정할 사원 번호 입력(-1종료) : ");
			...
			if (members.size()>0)
			{
				...
				System.out.printf("기존 주민등록번호yymmdd-nnnnnnn) : %s\n" , mSsn);
	...
	public void memberDelete()
	{
		...
		try
		{
			System.out.print("삭제할 직원의 사원 번호 입력 : ");
			String value = sc.next();
			...
			if (members.size()>0)
			{
				...
				System.out.printf("%d %5s %s %s %s %s %s %s %10d %10d %10d\n"
